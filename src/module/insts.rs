    ...
    pub fn from_code_bytes(code_bytes: Vec<u8>) -> Result<Vec<Instruction>> {
        ...
        while !binary_reader.eof() {
            ...
            match opcode {
                ...
                WASM_OP_I32_EQ => insts.push(Instruction::I32Binp(I32Binop::Eq)),
                WASM_OP_I32_NE => insts.push(Instruction::I32Binp(I32Binop::Ne)),
                WASM_OP_I32_LT_S => insts.push(Instruction::I32Binp(I32Binop::LtS)),
                WASM_OP_I32_LT_U => insts.push(Instruction::I32Binp(I32Binop::LtU)),
                WASM_OP_I32_GT_S => insts.push(Instruction::I32Binp(I32Binop::GtS)),
                WASM_OP_I32_GT_U => insts.push(Instruction::I32Binp(I32Binop::GtU)),
                WASM_OP_I32_LE_S => insts.push(Instruction::I32Binp(I32Binop::LeS)),
                WASM_OP_I32_LE_U => insts.push(Instruction::I32Binp(I32Binop::LeU)),
                WASM_OP_I32_GE_S => insts.push(Instruction::I32Binp(I32Binop::GeS)),
                WASM_OP_I32_GE_U => insts.push(Instruction::I32Binp(I32Binop::GeU)),
                ...
                WASM_OP_I32_ADD => insts.push(Instruction::I32Binp(I32Binop::Add)),
                WASM_OP_I32_SUB => insts.push(Instruction::I32Binp(I32Binop::Sub)),
                WASM_OP_I32_MUL => insts.push(Instruction::I32Binp(I32Binop::Mul)),
                WASM_OP_I32_DIV_S => insts.push(Instruction::I32Binp(I32Binop::DivS)),
                WASM_OP_I32_DIV_U => insts.push(Instruction::I32Binp(I32Binop::DivU)),
                WASM_OP_I32_REM_S => insts.push(Instruction::I32Binp(I32Binop::RemS)),
                WASM_OP_I32_REM_U => insts.push(Instruction::I32Binp(I32Binop::RemU)),
                WASM_OP_I32_AND => insts.push(Instruction::I32Binp(I32Binop::And)),
                WASM_OP_I32_OR => insts.push(Instruction::I32Binp(I32Binop::Or)),
                WASM_OP_I32_XOR => insts.push(Instruction::I32Binp(I32Binop::Xor)),
                WASM_OP_I32_SHL => insts.push(Instruction::I32Binp(I32Binop::Shl)),
                WASM_OP_I32_SHR_S => insts.push(Instruction::I32Binp(I32Binop::ShrS)),
                WASM_OP_I32_SHR_U => insts.push(Instruction::I32Binp(I32Binop::ShrU)),
                WASM_OP_I32_ROTL => insts.push(Instruction::I32Binp(I32Binop::Rotl)),
                WASM_OP_I32_ROTR => insts.push(Instruction::I32Binp(I32Binop::Rotr)),
